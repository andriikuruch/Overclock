...
public interface UserDAO {
    ...
    String INSERT_USER = "INSERT ALL " +
            ...
            "VALUES (41, OBJECT_ID_SEQ.CURRVAL, TO_DATE(CURRENT_DATE, 'dd/mm/yyyy hh24:mi')) /*REGISTRATION DATE*/ " +
            "INTO ATTRIBUTES (ATTR_ID, OBJECT_ID, LIST_VALUE_ID) " +
            "VALUES (42, OBJECT_ID_SEQ.CURRVAL, ?) /*ROLE*/ " +
            "SELECT TO_CHAR(SYSDATE, 'dd/mm/yyyy hh24:mi') CURRENT_DATE FROM DUAL";
